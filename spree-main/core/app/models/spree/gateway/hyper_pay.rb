module Spree
  class Gateway::HyperPay < Gateway
    ...
    def create_profile(payment)
      puts 'creating profiles here HYPER PAY HYPE PAY'
      puts payment.to_json
      puts 'creating profiles here HYPER PAY HYPE PAY 2'

      puts payment.source_type.to_json
      puts payment.source.to_json
    ...
    def authorize(_money, credit_card, _options = {})
      begin
        response=authorize_payment(credit_card.gateway_payment_profile_id, _money/100)
    ...
    def purchase(_money, credit_card, _options = {})
      puts 'purchase here HYPER PAY HYPE PAY'
    ...
    def credit(_money, _credit_card, _response_code, _options = {})
      puts 'credit here HYPER PAY HYPE PAY'
    ...
    def capture(_money, authorization, _gateway_options)
      begin
        response=capture_payment(authorization, _money)
    ...
    def void(_response_code, _credit_card, _options = {})
      puts 'capture here HYPER PAY HYPE PAY'
    ...
    def test?
      puts 'capture TEST HYPER PAY HYPE PAY'
    ...
    def payment_profiles_supported?
      puts 'capture here payment_profiles_supported HYPER PAY HYPE PAY'

      true
    end

    def payment_source_class
      puts 'capture here payment_source_class HYPER PAY HYPE PAY'

      CreditCard
    end

    def actions
      puts 'capture here actions HYPER PAY HYPE PAY'
    ...
    def generate_profile_id(success)
      puts 'prfile here HYPER PAY HYPE PAY'
